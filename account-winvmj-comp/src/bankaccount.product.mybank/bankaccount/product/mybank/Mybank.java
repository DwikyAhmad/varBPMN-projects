...
import accountpl.account.MybankResourceFactory;
import accountpl.account.core.resource.MybankResourceImpl;
...
public class Mybank {
	...
	public static void createObjectsAndBindEndPoints() {
		...
		MybankResourceImpl mybankresource = MybankResourceFactory.createResource("accountpl.account.core.resource.MybankResourceImpl");
		Router.route(mybankresource);
		System.out.println("MybankResource endpoints binding");
		mybankresource.accountAccount2Service = accountAccount2Service;
		mybankresource.dailylimitAccount2Service = dailylimitAccount2Service;
