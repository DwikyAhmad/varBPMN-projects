...
import accountpl.account.LoanResourceFactory;
...
public class Mybank {
	...
	public static void createObjectsAndBindEndPoints() {
		...
		LoanResourceImpl loanresource = LoanResourceFactory.createResource("accountpl.account.core.resource.LoanResourceImpl");
		Router.route(loanresource);
		System.out.println("LoanResource endpoints binding");
		loanresource.accountAccount2Service = accountAccount2Service;
		loanresource.dailylimitAccount2Service = dailylimitAccount2Service;
