...
import accountpl.account.DlamountResourceFactory;
...
public class Mybank {
	...
	public static void createObjectsAndBindEndPoints() {
		...
		DlamountResourceImpl dlamountresource = DlamountResourceFactory.createResource("accountpl.account.core.resource.DlamountResourceImpl");
		Router.route(dlamountresource);
		System.out.println("DlamountResource endpoints binding");
		dlamountresource.accountAccount2Service = accountAccount2Service;
		dlamountresource.dailylimitAccount2Service = dailylimitAccount2Service;
