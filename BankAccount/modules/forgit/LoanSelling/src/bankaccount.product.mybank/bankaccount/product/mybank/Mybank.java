...
import accountpl.account.LoanSellingResourceFactory;
...
public class Mybank {
	...
	public static void createObjectsAndBindEndPoints() {
		...
		LoanSellingResourceImpl loanSellingresource = LoanSellingResourceFactory.createResource("accountpl.account.core.resource.LoanSellingResourceImpl");
		Router.route(loanSellingresource);
		System.out.println("LoanSellingResource endpoints binding");
		loanSellingresource.accountAccount2Service = accountAccount2Service;
		loanSellingresource.dailylimitAccount2Service = dailylimitAccount2Service;
