// @generated from Transferrr.bpmn2
...
public class TransferrrResourceImpl extends TransferrrResourceComponent {
    ...
    static interface TransferrrService {
        void transfer(Map<String, Object> requestBody, String processid, Map<String, Object> response);

    }

    static class TransferrrServiceImpl implements TransferrrService {
	    @Override
	...
	private static TransferrrService transferrrService = new TransferrrServiceImpl();
    ...
    public Map<String, Object> transfer(VMJExchange vmjExchange) {
		...
		transferrrService.transfer(requestBody, processid, response);
