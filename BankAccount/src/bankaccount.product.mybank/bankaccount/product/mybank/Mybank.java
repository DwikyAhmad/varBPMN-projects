...
import accountpl.account.TransferrrResourceFactory;
import accountpl.account.core.resource.TransferrrResourceImpl;
...
public class Mybank {
	...
	public static void createObjectsAndBindEndPoints() {
		...
		TransferrrResourceImpl transferrrresource = TransferrrResourceFactory.createResource("accountpl.account.core.resource.TransferrrResourceImpl");
		Router.route(transferrrresource);
		System.out.println("TransferrrResource endpoints binding");
		transferrrresource.accountAccount2Service = accountAccount2Service;
		transferrrresource.dailylimitAccount2Service = dailylimitAccount2Service;
